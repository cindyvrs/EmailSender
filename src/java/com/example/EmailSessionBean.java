...
public EmailSessionBean(String smtpServ, String user,String password,String auth,String from,String to,String message,String subject,String attachPath,String name,String mess) {
        this.user=user;
        this.from = from;
        this.auth = auth;
